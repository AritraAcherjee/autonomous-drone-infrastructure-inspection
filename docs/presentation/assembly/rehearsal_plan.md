...
| 12 | P18 Clean Repeatability | 0:40 | Explain accepted clean repeatability. | New run identity detail. |
| 13 | P19 Localization Evaluation | 0:55 | Present frozen measured metrics without a PASS threshold. | Method subclauses. |
| 14 | P19 Spatial Validation Status | 0:45 | Separate demonstrated spatial chain from pending final correspondence. | Slot mechanics. |
...
| 19 | Current Demonstrated Capability | 0:35 | Close with demonstrated capability and two bounded pending inputs. | Supporting sentence. |
